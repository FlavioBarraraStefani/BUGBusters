window.addEventListener('resize', () => { if (window._draw_attack_4_lastCall) draw_attack_4(...window._draw_attack_4_lastCall); });

function draw_attack_4(data, choice, containerId) {
  window._draw_attack_4_lastCall = [data, choice, containerId];
