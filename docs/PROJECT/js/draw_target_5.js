window.addEventListener('resize', () => { if (window._draw_target_5_lastCall) draw_target_5(...window._draw_target_5_lastCall); });

function draw_target_5(data, choice, containerId) {
  window._draw_target_5_lastCall = [data, choice, containerId];
