window.addEventListener('resize', () => { if (window._draw_target_4_lastCall) draw_target_4(...window._draw_target_4_lastCall); });

function draw_target_4(data, choice, containerId) {
  window._draw_target_4_lastCall = [data, choice, containerId];
