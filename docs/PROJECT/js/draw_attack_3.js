window.addEventListener('resize', () => { if (window._draw_attack_3_lastCall) draw_attack_3(...window._draw_attack_3_lastCall); });

function draw_attack_3(data, choice, containerId) {
