window.addEventListener('resize', () => { if (window._draw_attack_5_lastCall) draw_attack_5(...window._draw_attack_5_lastCall); });

function draw_attack_5(data, choice, containerId) {
  window._draw_attack_5_lastCall = [data, choice, containerId];
